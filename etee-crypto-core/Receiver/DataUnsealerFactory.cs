...
namespace Egelke.EHealth.Etee.Crypto.Receiver
{
    ...
    {
        /// <summary>
        /// Creates an instance of the <see cref="IDataUnsealer"/> inferface to unseal messages.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Can be used to unseal messages of any type of level, but for T-leves only if a 
        ...
        public static IDataUnsealer Create(X509Certificate2Collection encCerts, Level? level)
        {
            return new TripleUnwrapper(level, null, encCerts);
        }

        /// <summary>
        /// Creates an instance of the <see cref="IDataUnsealer"/> inferface to unseal messages that where obtained from a time-mark authority.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// In case the message does contain a timestamp, it will be used and the time-mark authority will be ignored.
        /// </para>
        /// </remarks>
        /// <param name="encCerts">Own (eHealth issued) certificates with private key that can be used to decrypt, they must have an <strong>exportable</strong> private key</param>
        ...
        /// <returns>Instance of the IDataUnsealer for messsages of the specified a time-mark authority</returns>
        public static IDataUnsealer CreateFromTimemarkAuthority(X509Certificate2Collection encCerts, Level level, ITimemarkProvider timemarkauthority)
        {
            ...
            if (timemarkauthority == null) throw new ArgumentNullException("timemarkauthority", "This method requires an timemark authority specified");
