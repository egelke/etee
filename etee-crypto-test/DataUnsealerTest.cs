...
namespace Siemens.eHealth.ETEE.Crypto.Test
{
    ...
    public class DataUnsealerTest
    {
        ...
        public static void MyClassInitialize() {
            bobAuth = new X509Certificate2("../../imports/users/bob_auth.p12", "test", X509KeyStorageFlags.Exportable);
            bobEnc = new X509Certificate2("../../imports/users/bob_enc.p12", "test", X509KeyStorageFlags.Exportable);
            aliceAuth = new X509Certificate2("../../imports/users/alice_auth.p12", "test", X509KeyStorageFlags.Exportable);
            aliceEnc = new X509Certificate2("../../imports/users/alice_enc.p12", "test", X509KeyStorageFlags.Exportable);
            dirkAuth = new X509Certificate2("../../imports/users/dirk_auth.p12", "test", X509KeyStorageFlags.Exportable);
            dirkEnc = new X509Certificate2("../../imports/users/dirk_enc.p12", "test", X509KeyStorageFlags.Exportable);
            nialaAuth = new X509Certificate2("../../imports/users/niala_auth.p12", "test", X509KeyStorageFlags.Exportable);
            nialaEnc = new X509Certificate2("../../imports/users/niala_enc.p12", "test", X509KeyStorageFlags.Exportable);
            niala2Auth = new X509Certificate2("../../imports/users/niala2_auth.p12", "test", X509KeyStorageFlags.Exportable);
            niala2Enc = new X509Certificate2("../../imports/users/niala2_enc.p12", "test", X509KeyStorageFlags.Exportable);
            niala3Auth = new X509Certificate2("../../imports/users/niala3_auth.p12", "test", X509KeyStorageFlags.Exportable);
            niala3Enc = new X509Certificate2("../../imports/users/niala3_enc.p12", "test", X509KeyStorageFlags.Exportable);
            niala4Auth = new X509Certificate2("../../imports/users/niala4_auth.p12", "test", X509KeyStorageFlags.Exportable);
            niala4Enc = new X509Certificate2("../../imports/users/niala4_enc.p12", "test", X509KeyStorageFlags.Exportable);
            oldHospAuth = new X509Certificate2("../../imports/users/oldHospital_auth.p12", "test", X509KeyStorageFlags.Exportable);
            oldHospEnc = new X509Certificate2("../../imports/users/oldHospital_enc.p12", "test", X509KeyStorageFlags.Exportable);
            hospAuth = new X509Certificate2("../../imports/users/hospital_auth.p12", "test", X509KeyStorageFlags.Exportable);
            hospEnc = new X509Certificate2("../../imports/users/hospital_enc.p12", "test", X509KeyStorageFlags.Exportable);
        }
        ...
        public void Clear()
        {
            ...
            FileStream fs = new FileStream("../../msg/clear.txt", FileMode.Open);
            using (fs)
            {
        ...
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            FileStream fs = new FileStream("../../msg/openssl_encrypted.msg", FileMode.Open);
            using (fs)
            {
                UnsealResult result = unsealer.Unseal(fs);
            }
        ...
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            FileStream fs = new FileStream("../../msg/openssl_inner_signed.msg", FileMode.Open);
            using (fs)
            {
            UnsealResult result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidAlgo()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/openssl_outer_signed.msg", FileMode.Open);
            using (fs)
            {
            ...
            Assert.AreEqual(Siemens.EHealth.Etee.Crypto.Decrypt.TrustStatus.Unsure, result.SecurityInformation.TrustStatus);
        ...
        public void InvalidAlgoBigFile()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/openssl_outer_signed_big.msg", FileMode.Open);
            using (fs)
            {
                result = unsealer.Unseal(fs);
            }
        ...
        public void eid()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_both_eid_certs_signed.msg", FileMode.Open);
            using (fs)
            {
                result = unsealer.Unseal(fs);
            }
            ...
            Assert.AreEqual(ValidationStatus.Invalid, result.SecurityInformation.ValidationStatus);
            Assert.AreEqual(Siemens.EHealth.Etee.Crypto.Decrypt.TrustStatus.None, result.SecurityInformation.TrustStatus);
        ...
        public void eidExpired()
        {
            unsealer = DataUnsealerFactory.Create(dirkEnc, dirkAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_both_expired_eid_certs_signed.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void eidRevoked()
        {
            unsealer = DataUnsealerFactory.Create(dirkEnc, dirkAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_both_revoked_eid_certs_signed.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void eidSuspended()
        {
            unsealer = DataUnsealerFactory.Create(dirkEnc, dirkAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_both_suspended_eid_certs_signed.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void eidNoCrlUri()
        {
            unsealer = DataUnsealerFactory.Create(dirkEnc, dirkAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_certs_contain_no_crluri.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void eidNonExistingCrlUri()
        {
            unsealer = DataUnsealerFactory.Create(dirkEnc, dirkAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_certs_contain_noexisting_crluri.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void Correct()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_correct.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
            ...
            Assert.AreEqual(EHealth.Etee.Crypto.Decrypt.TrustStatus.Unsure, result.SecurityInformation.TrustStatus);
            Assert.AreEqual("this is a test message for a correctly triple wrapped message", clear);
        }
        ...
        public void crossSigned()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_cross_signed.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
            ...
            Assert.AreEqual(ValidationStatus.Invalid, result.SecurityInformation.InnerSignature.ValidationStatus);
            Assert.IsTrue(result.SecurityInformation.InnerSignature.SecurityViolations.Contains(SecurityViolation.NotSignatureValid));
            Assert.AreEqual("this is an ehealth test message", clear);
        }
        ...
        public void ExpiredAuth()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_expired_auth.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void ExpiredEnc()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_expired_encr.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
            ...
            Assert.AreEqual(ValidationStatus.Valid, result.SecurityInformation.ValidationStatus);
            Assert.AreEqual(EHealth.Etee.Crypto.Decrypt.TrustStatus.None, result.SecurityInformation.TrustStatus);
            Assert.IsTrue(result.SecurityInformation.SecurityViolations.Contains(UnsealSecurityViolation.UntrustedRecipient));
            Assert.AreEqual(EHealth.Etee.Crypto.Decrypt.TrustStatus.None, result.SecurityInformation.Encryption.TrustStatus);
            ...
            Assert.AreEqual("this is test message that is wrapped with wrong parameters", clear);
        }
        ...
        public void InvalidCertChain()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_invalid_cert_chain.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidCmsSigned()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_invalid_cms_signed.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidEncrypted()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_invalid_encrypted.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidInnerSigned()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_invalid_inner_signed.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidKeySize()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_invalid_key_size.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidKeyUsage()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_invalid_key_usage.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidSignature()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_invalid_signature.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidMultiSignTimes()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_more_signing_times.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void MultiRecipients()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_multi_recipients.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void NotValidYet()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_not_valid_yet_auth.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
            ...
            Assert.AreEqual("this is the message content", clear);
        }
        ...
        public void Revoked()
        {
            unsealer = DataUnsealerFactory.Create(dirkEnc, dirkAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_revoked_cert.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void DsaSignatureWithRsaKey()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_signed_with_other_key_and_algo.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void UnauthorizedAlgos()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_unauthorized_algos.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
            ...
            Assert.AreEqual("use invalid algos", clear);
        }
        ...
        public void UnsupportedAlgos()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_unsupported_algos.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
            ...
            Assert.IsTrue(result.SecurityInformation.InnerSignature.SecurityViolations.Contains(SecurityViolation.NotAllowedSignatureDigestAlgorithm));
            Assert.IsTrue(result.SecurityInformation.InnerSignature.SecurityViolations.Contains(SecurityViolation.NotAllowedSignatureEncryptionAlgorithm));
            Assert.AreEqual("use unsupported signature algos", clear);
        }
        ...
        public void WasNotValidYet()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_was_not_valid_yet_auth.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void MultiSigned()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_with_2_signerinfos.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void WithoutCerts()
        {
            unsealer = DataUnsealerFactory.Create(niala4Enc, niala4Auth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_without_certset.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void InvalidInnerSignature()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_without_inner_eid_cert.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
        ...
        public void MissingOuterCertificate()
        {
            unsealer = DataUnsealerFactory.Create(bobEnc, bobAuth);
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_without_outer_eid_cert.msg", FileMode.Open);
            using (fs)
            {
                 result = unsealer.Unseal(fs);
            }
            ...
            Assert.AreEqual(ValidationStatus.Unsure, result.SecurityInformation.ValidationStatus);
            Assert.AreEqual(EHealth.Etee.Crypto.Decrypt.TrustStatus.None, result.SecurityInformation.TrustStatus);
        ...
        public void WrongEncryption()
        {
            ...
            UnsealResult result;
            FileStream fs = new FileStream("../../msg/triple_wrapped_wrong_encryption_key.msg", FileMode.Open);
            using (fs)
            {
                result = unsealer.Unseal(fs);
            }
